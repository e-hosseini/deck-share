    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="icon" asChild title="Edit deck">
      ...
      {deck.description && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>The description of the deck.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-muted-foreground text-sm prose prose-sm dark:prose-invert max-w-none line-clamp-1" dangerouslySetInnerHTML={{ __html: deck.description }} />
          </CardContent>
        </Card>
      )}
